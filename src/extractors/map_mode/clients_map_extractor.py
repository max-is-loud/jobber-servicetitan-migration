"""ClientsMapExtractor for lightweight client entity discovery."""
...
class ClientsMapExtractor(BaseMapExtractor):
    """Map mode extractor for Client entities - lightweight discovery pass."""
    ...
    def __init__(
        ...
        """Initialize ClientsMapExtractor.
    ...
    def _fetch_page(self, cursor: Optional[str] = None) -> dict[str, Any]:
        """Fetch a page of clients using map mode query."""
    ...
    def _map_entity(self, node: dict[str, Any]) -> EntityInventory:
        """Map a client node to EntityInventory with relation counts."""
