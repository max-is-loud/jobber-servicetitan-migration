...
def _simulate_oauth_manager_exchange_code_for_tokens(authorization_code: str) -> Dict[str, Any]:
    """
...
def oauth_callback_fixed(
    ...
    try:
        ...
        typer.echo("Please try the authorization flow again with 'tightbeam oauth init'", err=True)
        sys.exit(1)
